...
namespace SpaceTrader.UI
{
    public static class ColorTheme
    {
        ...
        // Brighter than the canvas background so alternating row bands are clearly visible.
        public static readonly Color RowBg           = new Color(0.14f, 0.17f, 0.28f, 1f);
        public static readonly Color RowAlt          = new Color(0.10f, 0.12f, 0.22f, 1f);
        ...
        public static readonly Color TextDisabled    = new Color(0.55f, 0.55f, 0.60f, 1f);
